            ...
            <div className="container flex flex-wrap items-center justify-between mx-auto text-slate-800">
                ...
                <div className="block">
                    <ul className="flex gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 flex-row lg:items-center lg:gap-6">
                        ...
                        <li className="flex items-center p-1 text-sm gap-x-2 text-slate-600">
                            <button onClick={() => { logout() }} className="cursor-pointer text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                                logout
                            </button>
                        </li>
                    </ul>
