...
export const AboutUs = () => {
    ...
    const data = {
        ...
        stats: [
            { title: 'stats.0.title', description: 'stats.0.description' },
            { title: 'stats.1.title', description: 'stats.1.description' },
            { title: 'stats.2.title', description: 'stats.2.description' },
            { title: 'stats.3.title', description: 'stats.3.description' }
        ],
        button: 'DownloadMyResume'
    };
